...
@Transactional
public class SysDepartmentServiceImpl extends AbstractCoreService<SysDepartment, SysDepartmentExample> implements SysDepartmentService{
	...
	/* (non-Javadoc)
	 * @see com.yoju360.mgmt.security.service.SysDepartmentService#getModuleName()
	 */
	@Override
